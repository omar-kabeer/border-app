...
def main():
    ...
    if page_selection == "Home":
        tab1, tab2, tab3, tab4 = st.tabs(["Overview", "About", "Border Info", "Frequently Asked Questions (FAQs)"])
        with tab1:
            # Header contents
            ...
            st.markdown(
                "Welcome to our Border Control App. This app allows you to quickly identify and access electronic information about national border access points in Nigeria. You can search for border points by location, type, or contact information. You can also view and manage data about border points, and contribute to discussions about national policy on border control."
            )
        ...
        with tab3:
            ...
            st.markdown("## State and Local Government Information")

            st.dataframe(df.head(66))  # Same as st.write(df)
    ...
    if page_selection == "Intercommunication":
        st.title('Intercommunication')
        st.markdown(
            "This page allows you to communicate with other response agencies and the security services. You can do this through a chat function, a forum, or a messaging system."
        )

    if page_selection == "Data Management":
        st.title('Data Management')
        st.markdown(
            "This page allows you to view and manage data about border access points. This data includes the number of people who have crossed the border, the type of goods that have been imported or exported, and the number of security incidents that have occurred at the border."
        )

    if page_selection == "Policy Formulation":
        st.title('Policy Formulation')
        st.markdown(
            "This page allows you to view and contribute to discussions about national policy on border control. You can do this through a forum, a wiki, or a blog."
        )
